...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        MainApp app = new MainApp(roomManagementSessionBean, employeeSessionBean, partnerSessionBean, guestSessionBean, reservationSessionBean, allocationSessionBean);
        app.run();
    } 
}
